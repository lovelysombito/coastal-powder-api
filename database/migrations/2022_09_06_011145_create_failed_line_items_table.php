...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('failed_line_items', function (Blueprint $table) {
            $table->uuid('ncr_id')->nullable(false);
            $table->uuid('failed_line_item_id')->primary();
            $table->timestamps();
            $table->softDeletes();
            $table->uuid('product_id')->nullable();
            $table->uuid('failed_job_id');
            $table->uuid('deal_id');
    ...
    {
        Schema::dropIfExists('failed_line_items');
    }
};
