...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        {{-- <div style="display: flex;">
            ...
            <div>
                <p><strong>Coastal Powder</strong></p>
                <p>23 Main Street<p>
                <p>MARINEVILLE NSW 2000</p>
                <p>ABN</p>
                <p>11 111 111 138</p>
            </div>
        </div> --}}
        ...
        <div align="center" style="margin-top: 150px">
            <img src={{$signature}} width="300px" alt="">
            <p style="margin-top: 10px"><strong>{{$customer_name}}</strong><p>
            {{-- <p class="margin-0"><strong>Coastal Powder</strong></p> --}}
            <p style="margin-top: 10px"><strong>{{$customer_email}}</strong><p>
        </div>
    </body>
</html>
